========================================================================
    KONSOLENANWENDUNG: verminderste Umsatzsteuer-Projektübersicht
========================================================================

Diese verminderste Umsatzsteuer-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre verminderste Umsatzsteuer-Anwendung besteht.


verminderste Umsatzsteuer.vcxproj
...
verminderste Umsatzsteuer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen verminderste Umsatzsteuer.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
