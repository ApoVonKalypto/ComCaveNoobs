========================================================================
    KONSOLENANWENDUNG: Eingabezeichen-Projektübersicht
========================================================================

Diese Eingabezeichen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Eingabezeichen-Anwendung besteht.


Eingabezeichen.vcxproj
...
Eingabezeichen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Eingabezeichen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
